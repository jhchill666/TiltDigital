...
package gs {
	...
	public class TweenMax extends TweenFilterLite implements IEventDispatcher {
		...
		protected var _yoyoEase:Function; //On the up phase of a yoyo, we temporarily swap out the easing function for a reverse one, so we store the original here.
